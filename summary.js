...
function summary() {
    ...
    let min = totalTaskMinutes % 60;
    let hours = (totalTaskMinutes - min) / 60;
    console.log(hours + "Hrs" + ":" + min + "Mins");
    document.getElementById("totalTime").innerHTML = hours + "Hrs" + ":" + min + "Mins";
